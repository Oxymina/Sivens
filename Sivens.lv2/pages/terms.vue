  ...
  <v-container fluid class="pa-md-8">
    <v-row justify="center">
      <v-col cols="12" md="10" lg="8">
        <p class="text-subtitle-1 text-center grey--text text--darken-1 mb-8">
          Last Updated: {{ lastUpdated }}
        </p>

        <!-- Terms and Conditions Section -->
        <section id="terms" class="mb-12">
          <h2 class="text-h4 font-weight-medium mb-6 secondary--text">
            Terms and Conditions
          </h2>

          <div class="text-body-1 content-section">
            ...
            <p>
              ...
              exclusive property of Sievēns.lv and its licensors. Service is
            ...
            <p>
              ...
              laws of Latvia and the European Union, without regard to its
          ...
          <div class="text-body-1 content-section">
            ...
            <ul>
              ...
              <li>
                ...
                may be set through our site by our advertising partners. They
                may be used by those companies to build a profile of your
            ...
            <ul>
              ...
              <li>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  >https://support.microsoft.com/en-us/topic/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d</a
                >
              </li>
            </ul>
            <p>
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Read our Terms and Conditions and Cookie Policy.',
        },
      ],
    }
  },
...
.content-section p {
  line-height: 1.8;
  margin-bottom: 16px; /* Vuetify's default is often 16px for p */
}
...
.content-section a {
  color: var(--v-primary-base); /* Use Vuetify primary color for links */
